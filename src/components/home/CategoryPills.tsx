...
export default function CategoryPills() {
  ...
  return (
    <div className="sticky top-24 z-30 bg-[#05060f]/85 py-2 backdrop-blur-md">
      <div className="mx-auto flex max-w-3xl items-center gap-2 px-4">
        {/* search → games page */}
        <Link
          href="/games"
          className="flex min-w-0 flex-1 items-center gap-2 rounded-full border border-white/12 bg-white/5 px-2 py-2 text-ink-soft"
        >
