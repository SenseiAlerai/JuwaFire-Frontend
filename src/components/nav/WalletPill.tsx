...
export default function WalletPill() {
  ...
  return (
    <Link
      href="/dashboard"
      aria-label="Wallet"
      className="flex items-center gap-2 rounded-full border border-gold/40 bg-black/40 py-1 pl-2.5 pr-1 shadow-[0_0_18px_-6px_rgba(255,198,61,0.8)]"
    >
      ...
      <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[linear-gradient(135deg,#ffc63d,#ff5c3b)] text-[#1a0e02]">
