...
export const VIP_TIERS: VipTier[] = [
  { name: "Bronze", perk: "Daily free spins", cashback: "5%", color: "#cd7f32", icon: "flame", minDepositCents: 0 },
  { name: "Silver", perk: "Weekly bonus box", cashback: "8%", color: "#9fb3c8", icon: "sparkles", minDepositCents: 10000 },
  { name: "Gold", perk: "Priority support", cashback: "12%", color: "#ffc63d", icon: "coins", minDepositCents: 50000 },
  { name: "Platinum", perk: "Faster payouts", cashback: "15%", color: "#7c9cff", icon: "crown", minDepositCents: 150000 },
  { name: "Diamond", perk: "Personal host + top cashback", cashback: "20%", color: "#67e8f9", icon: "gem", minDepositCents: 500000 },
];
