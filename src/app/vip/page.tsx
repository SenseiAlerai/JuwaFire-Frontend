...
const PERKS = [
  ...
  { icon: Crown, title: "Bigger Cashback", text: "Up to 20% back, every single week, no strings." },
];
        ...
        <div className="text-center">
          <Reveal>
            ...
            <p className="mx-auto mt-3 max-w-2xl text-lg text-ink-soft">
              Every spin earns you voltage. Collect enough and you&apos;ll surge up the ladder —
              from your first Spark to full Ringmaster glory.
            </p>
          </Reveal>
        </div>
          ...
          <div className="relative mt-16 overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(120deg,#1a0a3a,#2a0a3f)] p-10 text-center text-white shadow-[0_30px_80px_-30px_rgba(176,86,255,0.6)] sm:p-16">
            ...
            <div className="relative">
              <h2 className="font-display text-4xl font-extrabold sm:text-5xl">
                Start collecting voltage tonight
              </h2>
              <p className="mx-auto mt-3 max-w-xl text-white/85">
                Every game you play charges you up the ladder. No fee to join — just play,
                climb, and enjoy the perks.
              </p>
